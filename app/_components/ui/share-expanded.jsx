...
const ShareExpanded = ({ asChild, shareUrl, children }) => {
    ...
    return (
        <div className="flex items-center gap-2">
            <Button onClick={copyLink} variant='ghost' className='size-9 min-w-9 cursor-pointer' title='Copiar link'>
                {copied ? <CheckCheck className='size-4 min-w-4 text-positive' /> : <Copy className='size-4 min-w-4' />}
            </Button>
            <WhatsappShareButton url={url} className='flex items-center gap-2 text-sm'>
                <div className={cn('size-9 min-w-9', buttonVariants({ variant: 'ghost' }))} title='Compartilhar no WhatsApp'>
            ...
            <FacebookShareButton url={url} className='flex items-center gap-2 text-sm'>
                <div className={cn('size-9 min-w-9', buttonVariants({ variant: 'ghost' }))} title='Compartilhar no Facebook'>
            ...
            <TwitterShareButton url={url} className='flex items-center gap-2 text-sm'>
                <div className={cn('size-9 min-w-9', buttonVariants({ variant: 'ghost' }))} title='Compartilhar no X (Twitter)'>
                    <X className='size-4 min-w-4' />
                </div>
            </TwitterShareButton>
            <LinkedinShareButton url={url} className='flex items-center gap-2 text-sm'>
                <div className={cn('size-9 min-w-9', buttonVariants({ variant: 'ghost' }))} title='Compartilhar no LinkedIn'>
